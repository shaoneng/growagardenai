// /src/app/api/analyze/route.ts (Fixed Date Validation)
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // --- 这是关键改动 ---
    // 将日期的验证规则从 "YYYY-MM-DD" 改为 "季节, Day X"
    ...
    const prompt = `
      You are an expert player and mentor for the farming simulation game "Grow a Garden". 
