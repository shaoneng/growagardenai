...
// ... (other code like MODEL_NAME, Item interface, itemsMap) ...
...
// FIX: Define a specific type for the detailed item object
...
export async function POST(req: NextRequest) {
  // ... (API_KEY check and request body parsing) ...
  ...
  try {
    ...
    // ... (rest of the Gemini AI call logic) ...
